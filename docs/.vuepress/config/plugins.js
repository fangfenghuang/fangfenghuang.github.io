...
const feed_options = {
  canonical_base: 'https://fangfenghuang.github.io',
  count: 5000,
};
...
module.exports = [
  ...
  [
    'sitemap', {
      hostname: 'https://fangfenghuang.github.io',
      exclude: ["/404.html"],
    },
  ],
  ...
  // 站点地图
  'robots', {
    host: "https://fangfenghuang.github.io",
    disallowAll: false,
    allowAll: true,
    sitemap: "/sitemap.xml",
  },
  ...
  //       repo: 'https://github.com/fangfenghuang', // GitHub 仓库
  //       owner: 'fangfenghuang', // GitHub仓库所有者
  //       admin: ['fangfenghuang'], // 对仓库有写权限的人
