...
module.exports = {
  ...
  repo: 'https://github.com/fangfenghuang/fangfenghuang.github.io', // 导航栏右侧生成Github链接
  ...
  // bodyBgImg: 'bg.jpg', // body背景大图，默认无。 单张图片 String || 多张图片 Array, 多张图片时每隔15秒换一张。
  ...
  author: {
    ...
    name: 'hff', // 必需
    link: 'https://github.com/fangfenghuang', // 可选的
  },
  blogger: {
    // 博主信息，显示在首页侧边栏
    avatar: '/img/bg.jpeg',
  ...
  social: {
    ...
    icons: [
      ...
      },
      {
        ...
        title: '发邮件',
        link: 'mailto:15068704759@163.com',
      },
      {
        iconClass: 'icon-rss',
        title: 'linkedin',
        link: 'https://www.linkedin.com/in/huang-fangfeng-60887981/',
      },
    ],
  },
  ...
  footer: {
    ...
    copyrightInfo:
      '| <a rel="nofollow " target="_blank" href="https://github.com/fangfenghuang/fangfenghuang.GitHub.io">@fangfenghuang</a>', // 博客版权信息，支持a标签
  },
}